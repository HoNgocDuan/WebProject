                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">Quản lý danh mục loại sản phẩm</a>
                                </li>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div>
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <c:forEach items="${listPrdCategorys}" var="catalog">
                                                        <tr>
                                                            <td class="center">
                                                                <label class="pos-rel">
                                                                    <input type="checkbox" class="ace" />
                                                            ...
                                                            <td>
                                                                <a href="#">${catalog.prdCategoryID}</a>
                                                            </td>
                                                            <td>${catalog.prdCategoryTitle}</td>
                                                            
                                                            <td>${catalog.createDate}</td>
                                                            <td>${catalog.updateDate}</td>
                                                            <td><c:if test="${catalog.isActive==true}">Kích hoạt</c:if>
                                                                <c:if test="${catalog.isActive==false}">Không kích hoạt</c:if>
                                                            </td>

                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    <a class="blue" href="<%=request.getContextPath()%>/detailPrd.htm?categoryId=${catalog.prdCategoryID}">
                                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                    </a>

                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdate.htm?categoryId=${catalog.prdCategoryID}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>

                                                                    <a class="red" href="<%=request.getContextPath()%>/deletePrdCategory.htm?prdCategoryId=${catalog.prdCategoryID}">
