...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta charset="utf-8" />
		<title>Cập nhập đơn đặt hàng</title>
                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="updateOrderAdmin.htm"  commandName="order" class="form-horizontal" role="form" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <f:select path="isActive"  type="text" id="form-field-2" placeholder="Tình trạng đơn hàng" class="col-xs-10 col-sm-5" readonly="true">
                                                    <f:option value="1">Chờ xác nhận</f:option>
                                                      <f:option value="2">Đang giao hàng</f:option>
                                                      <f:option value="3">Hoàn thành</f:option>
                                                </f:select>
											...
											<tbody>
												...
												<tr>
													...
													<td>${product.productName}</td>
                                                                                                        ...
                                                                                                        <td>${product.priceAfterDiscount*product.quantity}</td>
