                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">Quản lý danh sách đơn đặt hàng</a>
                                </li>
                                                    ...
                                                    <c:forEach items="${listorder}" var="order">
                                                        <tr>
                                                            ...
                                                            <td>${order.phone}</td>
                                                              ...
                                                              <td><c:if test="${order.paymentId==1}">Thanh toán khi nhận hàng</c:if>
                                                                <c:if test="${order.paymentId==2}">Thanh toán qua ngân hàng</c:if>
                                                            </td>
                                                            <td>${order.createDate}</td>
                                                           
                                                            <td><c:if test="${order.isActive==1}">Chờ xác nhận</c:if>
                                                                <c:if test="${order.isActive==2}">Đang giao hàng</c:if>
                                                                <c:if test="${order.isActive==3}">Hoàn thành</c:if>
                                                            </td>

                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    <a class="blue" href="<%=request.getContextPath()%>/detailOrder.htm?orderId=${order.orderId}">
                                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                    </a>

                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdateOrder.htm?orderId=${order.orderId}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>
                                                                    <c:if test="${order.isActive==3}">
                                                                    <a class="red" href="<%=request.getContextPath()%>/removeOrderAdmin.htm?orderId=${order.orderId}">
