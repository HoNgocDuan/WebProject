                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="#"  commandName="order" class="form-horizontal" role="form" >
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Mã </label>

                                            <div class="col-sm-9">
                                                <f:input path="orderId" type="text" id="form-field-1" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                            ...
                                            <div class="col-sm-9">
                                                <f:input path="name" type="text" id="form-field-1" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <f:input path="phone" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>
                                            ...
                                            <div class="col-sm-9">
                                                <f:input path="email" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>
                                            ...
                                            <div class="col-sm-9">
                                                <f:input path="address" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>
                                               
                                            </div>
                                        </div>
                                                      <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Phương thức thanh toán </label>

                                            <div class="col-sm-9">
                                                <!--<f:select path="paymentId"  type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true">
                                                    <f:option value="1">Thanh toán khi nhận hàng</f:option>
                                                      <f:option value="2">Thanh toán qua thẻ</f:option>
                                                </f:select>-->
                                                <input  value="<c:if test="${order.paymentId==1}">Thanh toán khi giao hàng</c:if><c:if test="${order.paymentId==2}">Thanh toán qua tài khoản ngân hàng</c:if>" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>

                                               
                                            </div>
                                        </div>
                                                   <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Tình trạng đơn hàng </label>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input  value="<c:if test="${order.isActive==1}">Chờ xác nhận</c:if><c:if test="${order.isActive==2}">Đang giao hàng</c:if><c:if test="${order.isActive==3}">Hoàn thành</c:if>" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>
                                        ...
                                        <!--<div class="clearfix form-actions">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a class="btn btn-info" href="<%=request.getContextPath()%>/getAllPrdCategory.htm">Quay lại</a>
                                                &nbsp; &nbsp; &nbsp;
                                ...
                                <div class="col-xs-1"></div>
									<div class="col-xs-9">
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
                                                                                        <c:forEach items="${listordetail}" var="product">
												...
												<tr>
													...
													<td>${product.productName}</td>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <fmt:formatNumber maxFractionDigits="3" value="${product.priceAfterDiscount}"></fmt:formatNumber>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <fmt:formatNumber maxFractionDigits="3" value="${product.priceAfterDiscount*product.quantity}"></fmt:formatNumber>
                                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                                <fmt:formatNumber maxFractionDigits="3" value="${order.totalAmount}"></fmt:formatNumber></td>
                                                                                        </tr>
											</tbody>
										</table>
									</div><!-- /.span -->
                                            ...
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a class="btn btn-info" href="<%=request.getContextPath()%>/getAllOrderAdmin.htm">Quay lại</a>
                                                &nbsp; &nbsp; &nbsp;
