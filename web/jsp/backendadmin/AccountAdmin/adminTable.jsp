                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div>
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <c:forEach items="${lstAcc}" var="acc">
                                                        <tr>
                                                            

                                                            <td>
                                                                <a href="#">${acc.accountId}</a>
                                                            </td>
                                                            <td>${acc.userName}</td>
                                                            
                                                            <td>${acc.email}</td>
                                                            <td>${acc.createDate}</td>
                                                            <td><c:if test="${acc.userRole==1}">User</c:if>
                                                                <c:if test="${acc.userRole==2}">Admin</c:if>
                                                            </td>
                                                            <td><c:if test="${acc.isActive==true}">Kích hoạt</c:if>
                                                                <c:if test="${acc.isActive==false}">Không kích hoạt</c:if>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    ...
                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdateacc.htm?accId=${acc.accountId}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>
                                                                <c:if test="${acc.isActive==false}">
                                                                    <a class="red" href="<%=request.getContextPath()%>/removeAccAdmin.htm?accId=${acc.accountId}">
