                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="insertProductAdmin.htm"  commandName="newpro" class="form-horizontal" role="form" method="POST" enctype= "multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input  type="text" id="ProductPriceAfterDiscount"  class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img id="imagePreview" style="width: 300px; height: 300px;"/>
                                             <img id="imagePreview2" style="width: 300px; height: 300px;"/>
