                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="updateCommentAd.htm"  commandName="Comment" class="form-horizontal" role="form" >
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="accountId"> Mã tài khoản </label>

                                        <div class="col-sm-9">
                                            <f:input path="accountId" type="text" id="accountId" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="productId"> Mã sản phẩm </label>

                                        <div class="col-sm-9">
                                            <f:input path="productId" type="text" id="productId" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="content"> Nội dung bình luận </label>

                                        <div class="col-sm-9">
                                            <f:textarea path="content" type="text" id="content" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="createDate"> Ngày tạo </label>

                                        <div class="col-sm-9">
                                            <input  type="text" id="createDate" value="${Comment.createDate}" class="col-xs-10 col-sm-5" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="ratting"> Điểm đánh giá </label>

                                        <div class="col-sm-9">
                                            <f:input path="ratting" type="text" id="ratting"  class="col-xs-10 col-sm-5" readonly="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="status" type="text" id="status" placeholder="Trạng thái" class="col-xs-10 col-sm-5" >
