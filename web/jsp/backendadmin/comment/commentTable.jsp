                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="hidden-480">Trạng thái</th>
                                                                   <th class="hidden-480">Điểm đánh giá</th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <c:forEach items="${listComments}" var="comment">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#">${comment.accountId}</a>
                                                            </td>
                                                            <td>${comment.productId}</td>
                                                            
                                                            <td>${comment.createDate}</td>
                                                     
                                                            <td><c:if test="${comment.status==true}">Kích hoạt</c:if>
                                                                <c:if test="${comment.status==false}">Không kích hoạt</c:if>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    ...
                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdateCommentAdmin.htm?accId=${comment.accountId}&&proID=${comment.productId}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>
                                                                    <c:if test="${comment.status==false}">
                                                                    <a class="red" href="<%=request.getContextPath()%>/removeComment.htm?accId=${comment.accountId}&&proID=${comment.productId}">
