                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Chi tiết loại sản phẩm</li>
                            </ul><!-- /.breadcrumb -->
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="insertPrdCategory.htm"  commandName="detailPr" class="form-horizontal" role="form" >
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tên loại sản phẩm </label>

                                            <div class="col-sm-9">
                                                <f:input path="prdCategoryTitle" type="text" id="form-field-1" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Độ ưu tiên </label>

                                            <div class="col-sm-9">
                                                <f:input path="priority" type="text" id="form-field-2" placeholder="Độ ưu tiên" class="col-xs-10 col-sm-5" readonly="true"/>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <f:textarea path="prdCategoryDescription" id="prdCategoryDescription" type="text" id="form-field-2" placeholder="Mô tả" class="col-xs-10 col-sm-5" readonly="true" />
                                            ...
                                            <div class="col-sm-9">
                                                <f:input path="isActive" type="text" id="form-field-2" placeholder="Trạng thái" class="col-xs-10 col-sm-5" readonly="true" />
