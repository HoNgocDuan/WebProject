                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="updateProductAdmin.htm"  commandName="pro" class="form-horizontal" role="form" method="POST" enctype= "multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="productName" type="text" id="form-field-1" placeholder="Tên" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="prdCategoryId" type="text" id="form-field-2" placeholder="Loại sản phẩm" class="col-xs-10 col-sm-5" >

                                                <c:forEach items="${lstPrdCate}" var="cate"><f:option value="${cate.prdCategoryID}">${cate.prdCategoryTitle}</f:option></c:forEach>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="ManufacturerId" type="text" id="form-field-5"  class="col-xs-10 col-sm-5" >

                                                <c:forEach items="${lstmanu}" var="manu"><f:option value="${manu.manufacturerId}">${manu.manufacturerName}</f:option></c:forEach>
                                            </f:select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input onchange="checkGia()" path="productPrice" type="text" id="productPrice" placeholder="Giá" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="productDiscount" onchange="checkGia()" type="text" id="productDiscount" placeholder="%" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="ProductPriceAfterDiscount" type="text" id="ProductPriceAfterDiscount"  class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="priority" type="text" id="form-field-6"  class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:textarea path="productDescription" id="prdCategoryDescription" type="text"  placeholder="Mô tả" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:textarea path="productTitle"  type="text" id="form-field-8" placeholder="Mô tả" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="isHotProduct" type="text" id="form-field-2" placeholder="Trạng thái" class="col-xs-10 col-sm-5" >
                                                <f:option value="true">Kích hoạt</f:option>
                                                <f:option value="false">Không kích hoạt</f:option>
                                            </f:select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="isActive" type="text" id="form-field-10" placeholder="Trạng thái" class="col-xs-10 col-sm-5" >
                                                <f:option value="true">Kích hoạt</f:option>
                                                <f:option value="false">Không kích hoạt</f:option>
                                            </f:select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="anhChinh" type="file" id="image" onchange="PreviewImage()" placeholder="Trạng thái" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="AnhChinh2" type="file" id="image2" onchange="PreviewImage1()" placeholder="Trạng thái" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="/WebProject${pro.anhChinh}" id="imagePreview" style="width: 300px; height: 300px;"/>
                                             <img src="/WebProject${pro.getAnhChinh2()}" id="imagePreview2" style="width: 300px; height: 300px;"/>
