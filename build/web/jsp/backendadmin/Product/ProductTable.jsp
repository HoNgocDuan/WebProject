                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">Quản lý danh sách sản phẩm</a>
                                </li>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <c:forEach items="${listProduct}" var="pr">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#">${pr.productId}</a>
                                                            </td>
                                                            <td>${pr.productName}</td>
                                                            <td><fmt:formatNumber maxFractionDigits="3" value="${pr.getProductPriceAfterDiscount()}"></fmt:formatNumber></td>
                                                           
                                                            <td>${pr.productTitle}</td>
                                                             
                                                            <td>${pr.createDate}</td>
                                                           
                                                            <td><c:if test="${pr.isActive==true}">Kích hoạt</c:if>
                                                                <c:if test="${pr.isActive==false}">Không kích hoạt</c:if>
                                                             
                                                            </td>

                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    <a class="blue" href="<%=request.getContextPath()%>/DetailProduct.htm?productId=${pr.productId}">
                                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                    </a>

                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdateProductAdmin.htm?productId=${pr.productId}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>
                                                                    
                                                                    <a class="red" href="<%=request.getContextPath()%>/removeProductAdmin.htm?productId=${pr.productId}">
