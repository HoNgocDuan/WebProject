                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="updateAccountAdmin.htm"  commandName="ac" class="form-horizontal" role="form" >
                                                <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Mã người dùng </label>

                                            <div class="col-sm-9">
                                                <f:input path="accountId" type="text" id="form-field-1" placeholder="Tên" class="col-xs-10 col-sm-5" readonly="true"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
