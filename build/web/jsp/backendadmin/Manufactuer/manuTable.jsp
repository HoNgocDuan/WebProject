                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs" id="breadcrumbs">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">Quản lý danh mục thương hiệu</a>
                                </li>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <c:forEach items="${listmanu}" var="manu">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#">${manu.manufacturerId}</a>
                                                            </td>
                                                            <td>${manu.manufacturerName}</td>
                                                            
                                                           
                                                            <td><c:if test="${manu.isActive==true}">Kích hoạt</c:if>
                                                                <c:if test="${manu.isActive==false}">Không kích hoạt</c:if>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    ...
                                                                    <a class="green" href="<%=request.getContextPath()%>/initUpdateManufactuerAdmin.htm?manuId=${manu.manufacturerId}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>
                                                                    <c:if test="${manu.isActive==false}">
                                                                    <a class="red" href="<%=request.getContextPath()%>/deleteManuAdmin.htm?manuId=${manu.manufacturerId}">
