...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta charset="utf-8" />
		<title>Cập nhập ảnh sản phẩm</title>
                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                <f:form action="updateImg.htm"  commandName="UpImg" class="form-horizontal" role="form" method="POST" enctype= "multipart/form-data">
                                          <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Mã sản phẩm </label>

                                        <div class="col-sm-9">
                                            <f:input path="imageId" type="text"   placeholder="Mã" class="col-xs-10 col-sm-5" readonly="true"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:select path="productId" type="text" id="form-field-2" placeholder="Trạng thái" class="col-xs-10 col-sm-5" >
                                                <c:forEach items="${lstPrd}" var="pr"><f:option value="${pr.productId}">${pr.productName}</f:option></c:forEach> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <f:input path="url" type="file" id="image" onchange="PreviewImage()" placeholder="Trạng thái" class="col-xs-10 col-sm-5" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <img src="/WebProject${UpImg.url}" id="imagePreview" style="width: 300px; height: 300px;"/>
